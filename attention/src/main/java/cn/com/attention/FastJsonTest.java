...
public class FastJsonTest {
    public static void main(String[] args) {
        ...
        System.out.println(str1);//str1={"age":24,"name":"bob"}
        System.out.println(JSON.toJSONString(list));//[{"age":24,"name":"bob"},{"age":23,"name":"lily"}]
        System.out.println();
        ...
        System.out.println(stu1);//Student(name=bob, age=24)
        System.out.println();
